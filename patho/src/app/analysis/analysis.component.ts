...
export class AnalysisComponent implements OnInit {
  ...
  QcFormControl = this.formBuilder.group({
    ...
    parasite: ['', Validators.required],
    qualtiy: ['', Validators.required]
  });
  constructor(private router: Router, private route: ActivatedRoute, private formBuilder: FormBuilder, private sequencesService: dataService, private _snackBar: MatSnackBar, private condaService: CondaService, private uploadF: UploadFilesService) {
  }
  ...
  listFile() {
    ...
    this.uploadF.getFiles('ref_patho')
      .subscribe((reponse) => {
        reponse.forEach((data: any) => {
    ...
    this.uploadF.getFiles('ref_hote')
      .subscribe((reponse) => {
        reponse.forEach((data: any) => {
  ...
  onSubmit() {
    this.showlog = true
    this.color = 'white'
    this.condaService.pipe(this.QcFormControl.value)
      .subscribe(
        response => {
          this.showlog = false
          switch (response) {
    ...
    console.log(this.QcFormControl.value)
  }
