...
function clean() {
    exec('rm -fr uploads/res && mkdir uploads uploads/references uploads/res uploads/data uploads/references/human uploads/references/parasite uploads/res/dbsub uploads/res/qc', (err, stdout, stderr) => {
        if (err) { } else { }
    });
    const data = []
